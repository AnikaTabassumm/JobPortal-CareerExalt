  ...
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <path
          id="XMLID_1253_"
          d="M46,57.1c14.8,0,26.9-12.1,26.9-27C72.9,15.1,60.8,3,46,3S19.1,15.1,19.1,30C19.1,45,31.2,57.1,46,57.1z M46,11c10.4,0,18.9,8.5,18.9,19c0,10.5-8.5,19-18.9,19s-18.9-8.5-18.9-19C27.1,19.5,35.6,11,46,11z M58.5,59.7 c-1.3-0.4-2.8-0.1-3.8,0.8L46,67.9l-8.7-7.4c-1.1-0.9-2.5-1.2-3.8-0.8C27.9,61.5,0,71.1,0,85c0,2.2,1.8,4,4,4h84c2.2,0,4-1.8,4-4 C92,71.1,64.1,61.5,58.5,59.7z M10.1,81c4.4-4.7,15-9.9,23.8-12.9l9.5,8.1c1.5,1.3,3.7,1.3,5.2,0l9.5-8.1 c8.8,3.1,19.4,8.3,23.8,12.9H10.1z"
        ></path>{" "}
      </g>
    </svg>
  );
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        stroke-width="9"
      />
      <rect x="21" y="31" width="58" height="38" fill="green" />

      <circle cx="50" cy="45" r="8" fill="black" />

      <ellipse cx="50" cy="57" rx="10" ry="5" fill="black" />
      <rect x="40" y="57" width="20" height="7" fill="black" />

      <rect x="43" y="71" width="15" height="5" fill="black" />
      <rect x="38" y="76" width="25" height="5" fill="black" />
    </svg>
  );
};
...
const SearchSvg = ({ fill = "#000", width, height }) => {
  return (
    <svg
      width={width}
      height={height}
  ...
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <polyline points="40 40 48 32 40 24"></polyline>
        <polyline points="24 24 16 32 24 40"></polyline>
        <line x1="34" y1="22" x2="30" y2="42"></line>
      </g>
    </svg>
  );
};
  ...
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g id="_icons">
          {" "}
          <path d="M7.5,6.6C7.5,9,9.5,11,12,11s4.5-2,4.5-4.4c0-2.4-2-4.4-4.5-4.4S7.5,4.2,7.5,6.6z M14.5,6.6C14.5,7.9,13.4,9,12,9 S9.5,7.9,9.5,6.6s1.1-2.4,2.5-2.4S14.5,5.3,14.5,6.6z"></path>{" "}
          <path d="M6.6,16.8C7,15.1,8.4,14,10,14H14c0.8,0,1.6,0.3,2.3,0.8c0.4,0.4,1.1,0.3,1.4-0.1c0.4-0.4,0.3-1.1-0.1-1.4 c-1-0.8-2.3-1.3-3.6-1.3H10c-2.5,0-4.7,1.7-5.4,4.3l-0.5,1.9c-0.3,0.9-0.1,1.9,0.5,2.7C5.2,21.6,6,22,7,22h6.9c0.6,0,1-0.4,1-1 s-0.4-1-1-1H7c-0.4,0-0.6-0.2-0.7-0.4C6,19.4,5.9,19,6,18.7L6.6,16.8z"></path>{" "}
          <path d="M17.3,20.7c0.2,0.2,0.4,0.3,0.7,0.3c0.1,0,0.1,0,0.2,0c0.3-0.1,0.6-0.3,0.7-0.5l2-4c0.2-0.5,0-1.1-0.4-1.3 c-0.5-0.2-1.1,0-1.3,0.4l-1.4,2.8l-1-1c-0.4-0.4-1-0.4-1.4,0s-0.4,1,0,1.4L17.3,20.7z"></path>{" "}
        </g>{" "}
      </g>
    </svg>
  );
...
const InstagramSvg = ({
  ...
  const bgColor = hovered
    ? "url(#grad1)" // use gradient if hovered
    : defaultBgColor;
    ...
    >
      <defs>
        <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="20%" style={{ stopColor: "#5851db", stopOpacity: 1 }} />
...
const FacebookSvg = ({
  ...
  const bgColor = hovered ? "#1877F2" : defaultBgColor;
  const outlineColor = hovered ? "#ffffff" : defaultOutlineColor;
