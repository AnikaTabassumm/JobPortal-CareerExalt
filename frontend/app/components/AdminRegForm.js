...
const AdminRegistrationForm = forwardRef((props, ref) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isSignedUp) {
      ...
      try {
        ...
        if (result) {
          setIsOtpSent(true);
          // router.push('/dashboard'); // Or any other route after successful login
        }
      } catch (err) {
  ...
  return (
    <div className="w-11/12 md:w-9/12 lg:w-6/12 shadow-lg">
      <div
        style={{
